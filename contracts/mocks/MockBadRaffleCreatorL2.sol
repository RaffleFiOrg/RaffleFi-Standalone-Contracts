...
contract MockBadRaffleCreatorL2 {

    IRaffleFi public immutable raffleFi;

    constructor(address _raffleFi) payable {
    ...
    function completeRaffle(uint256 raffleId, bool accept) external payable {
        raffleFi.completeRaffle{value: msg.value}(raffleId, accept);
    }
